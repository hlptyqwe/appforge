...
require (
	...
	appforge/proto/builder v0.0.0-00010101000000-000000000000
...
require (
	appforge/proto/common v0.0.0-00010101000000-000000000000 // indirect
...
replace appforge/proto/builder => ../../proto/builder

replace appforge/proto/common => ../../proto/common

replace appforge/proto/core => ../../proto/core
