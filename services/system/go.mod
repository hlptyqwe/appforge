...
replace appforge/proto/common => ../../proto/common

replace appforge/proto/system => ../../proto/system

replace appforge/common => ../../common

replace appforge/proto/market => ../../proto/market

replace appforge/proto/option => ../../proto/option

replace appforge/proto/staking => ../../proto/staking

replace appforge/proto/trade => ../../proto/trade
