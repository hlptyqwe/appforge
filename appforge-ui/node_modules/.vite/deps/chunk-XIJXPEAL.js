      ...
      if (props) {
        if (true) {
          ...
          for (const key in props) {
            ...
            key[0] === "." || isCustomElement && !isReservedProp2(key) || dynamicProps && dynamicProps.includes(key)) {
...
function renderSlot(slots, name, props = {}, fallback, noSlotted, branchKey) {
  if (currentRenderingInstance.ce || currentRenderingInstance.parent && isAsyncWrapper(currentRenderingInstance.parent) && currentRenderingInstance.parent.ce) {
    const slotProps = branchKey != null && props.key == null ? extend2({}, props, { key: branchKey }) : props;
  ...
  const res = customRef((track2, trigger2) => {
    ...
    return {
      ...
      set(value) {
        ...
        if (hasChanged2(value, prevSetValue) && (hasChanged2(value, emittedValue) && !hasChanged2(emittedValue, prevEmittedValue) || // #13524: browsers differ in when they flush microtasks between
        // event listeners. If a v-model listener emits an intermediate value
        // and a following listener restores the model to its previous prop
        // value before parent updates are flushed, the parent render can be
        // deduped as having no prop change. Force a local update so DOM state
        // such as an input's value is synchronized back to the current model.
        hasVModel && prevSetValue !== EMPTY_OBJ2 && !hasChanged2(emittedValue, localValue))) {
          trigger2();
        }
        prevSetValue = value;
...
var vModelSelect = {
  ...
  created(el, { value, modifiers: { number } }, vnode) {
    ...
    addEventListener(el, "change", () => {
      ...
      el[assignKey](
        el.multiple ? isSet3(el._modelValue) ? new Set(selectedVal) : selectedVal : selectedVal[0]
      );
      el._assigning = true;
      nextTick(() => {
        el._assigning = false;
...
vue/dist/vue.runtime.esm-bundler.js:
  ...
  **)
*/
//# sourceMappingURL=chunk-XIJXPEAL.js.map
