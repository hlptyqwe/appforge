...
func RegisterAgentHandlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	...
	server.AddRoutes([]rest.Route{
		...
		{Method: http.MethodPost, Path: "/build-tasks/:id/cancel", Handler: platform.CancelPlatformBuildTaskHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/build-tasks/:id/retry", Handler: platform.RetryPlatformBuildTaskHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/credentials", Handler: platform.CreatePlatformOpenApiCredentialHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/credentials", Handler: platform.ListPlatformOpenApiCredentialsHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/credentials/:id/rotate", Handler: platform.RotatePlatformOpenApiCredentialHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/credentials/:id/revoke", Handler: platform.RevokePlatformOpenApiCredentialHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/webhooks", Handler: platform.CreatePlatformWebhookEndpointHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/webhooks", Handler: platform.ListPlatformWebhookEndpointsHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/webhooks/:id", Handler: platform.GetPlatformWebhookEndpointHandler(serverCtx)},
		{Method: http.MethodPut, Path: "/developer/webhooks/:id", Handler: platform.UpdatePlatformWebhookEndpointHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/webhooks/:id/rotate-secret", Handler: platform.RotatePlatformWebhookEndpointSecretHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/webhooks/:id/test", Handler: platform.TestPlatformWebhookEndpointHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/webhook-deliveries", Handler: platform.ListPlatformWebhookDeliveriesHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/webhook-deliveries/:id/replay", Handler: platform.ReplayPlatformWebhookDeliveryHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-integrations", Handler: platform.ListPlatformSourceIntegrationsHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-integrations/:platform/authorize", Handler: platform.CreatePlatformSourceOAuthAuthorizationHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-integrations/:id", Handler: platform.GetPlatformSourceIntegrationHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-integrations/:id/available-repositories", Handler: platform.ListPlatformSourceAvailableRepositoriesHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-integrations/:id/repositories/:repositoryId/authorize", Handler: platform.AuthorizePlatformSourceRepositoryHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-integrations/:id/disconnect", Handler: platform.DisconnectPlatformSourceIntegrationHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-repositories", Handler: platform.ListPlatformSourceRepositoriesHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-repositories/:id/revoke", Handler: platform.RevokePlatformSourceRepositoryHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-artifacts/import", Handler: platform.ImportPlatformSourceArtifactHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-build-triggers", Handler: platform.CreatePlatformSourceBuildTriggerHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-build-triggers", Handler: platform.ListPlatformSourceBuildTriggersHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-build-triggers/:id", Handler: platform.GetPlatformSourceBuildTriggerHandler(serverCtx)},
		{Method: http.MethodPut, Path: "/developer/source-build-triggers/:id", Handler: platform.UpdatePlatformSourceBuildTriggerHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/developer/source-build-triggers/:id/rotate-secret", Handler: platform.RotatePlatformSourceBuildTriggerSecretHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/developer/source-webhook-events", Handler: platform.ListPlatformSourceWebhookEventsHandler(serverCtx)},
		...
		{Method: http.MethodGet, Path: "/billing/plans", Handler: platform.ListPlatformBillingPlansHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/billing/subscription", Handler: platform.GetPlatformTenantBillingHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/billing/checkout", Handler: platform.CreatePlatformBillingCheckoutHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/billing/subscription/change", Handler: platform.ChangePlatformSubscriptionHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/billing/subscription/cancel", Handler: platform.CancelPlatformSubscriptionHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/billing/usage", Handler: platform.GetPlatformBillingUsageHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/billing/invoices", Handler: platform.ListPlatformInvoicesHandler(serverCtx)},
		{Method: http.MethodPost, Path: "/enterprise/local-agents", Handler: platform.CreatePlatformLocalAgentRegistrationHandler(serverCtx)},
		{Method: http.MethodGet, Path: "/enterprise/local-agents", Handler: platform.ListPlatformLocalAgentsHandler(serverCtx)},
