...
APPFORGE_PUBLIC_REPOSITORY_SECRET_AUDIT_REPORT_FILE="$license_tmp/v7-public-repository-secret-audit.json" \
  "$repo_root/deploy/acceptance/v7-public-repository-secret-audit.sh"
